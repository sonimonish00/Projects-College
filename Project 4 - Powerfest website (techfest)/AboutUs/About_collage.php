...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<div class="white-area">
		 ...
		 <img class="segment-img-small" src="../images/competitions/AboutGP.jpg" alt="img11"/>
		
<h5 align="center">About GPERI</h5>
	
		<div class="segment-content-desc">

		<div align="justify">
		<p style="color:black"; >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Department of Technical Education, Government of Gujarat had given the responsibility for establishing a Degree Engineering College to Gujarat Power Corporation Limited (GPCL - Government of Gujarat Undertaking) under PPP mode. Accordingly, GPCL has established Gujarat Power Education and Research Foundation (GPERF) which is registered as Society as well as Trust under Societies Registration Act, 1860 and Bombay Public Trust, 1950 respectively in June, 2010. GPERF has also obtained Income Tax Registration certificate u/s 12AAA and exemption certificate u/s 80G(5) of the Income Tax Act,1961. GPERF acts as an autonomous body in the entire Gujarat State for the promotion and development of education in various fields and branches of Engineering, Management, Technology, and Information & Communication.<br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The modest endeavor of GPERF in the educational establishment is Gujarat Power Engineering and Research Institute (GPERI) which commenced in the year 2011 at village Mewad, dist.Mehsana, Gujarat with the approval of All India Council of Technical Education (AICTE), New Delhi and affiliation with Gujarat Technical University (GTU), Ahmedabad. GPERI offers currently four graduate courses (Civil, Computer, Electrical and Mechanical ) in engineering and research opportunities to choose from. The institute has intentions to develop state-of-the-art laboratories and infrastructure to cater the need of high skilled employable engineers to the industry.</p></div>
		</div>
