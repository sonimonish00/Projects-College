 ...
 <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta name="apple-mobile-web-app-capable" content="yes" />    
      ...
      <meta http-equiv="cache-control" content="public" />
             ...
             <TITLE>ABOUT TECHFEST 2012-13</TITLE>
...
<div id="gallery-container">
    ...
    <ul class="items--small">
      <li class="item"><a href="#"><img src="../images/gallery/small-1.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-2.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-3.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-4.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-5.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-6.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-7.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-8.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-9.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-10.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-11.jpg" alt="" /></a></li>
      <li class="item"><a href="#"><img src="../images/gallery/small-12.jpg" alt="" /></a></li>
    </ul>
    <ul class="items--big">
      <li class="item--big">
        <a href="#">
      ...
      <li class="item--big">
        <a href="#">
          <figure>
            <img src="../images/gallery/big-9.jpg" alt="" />
            <figcaption class="img-caption">
      ...
      <li class="item--big">
        <a href="#">
          <figure>
            <img src="../images/gallery/big-10.jpg" alt="" />
            <figcaption class="img-caption">
      ...
      <li class="item--big">
        <a href="#">
          <figure>
            <img src="../images/gallery/big-11.jpg" alt="" />
            <figcaption class="img-caption">
      ...
      <li class="item--big">
        <a href="#">
          <figure>
            <img src="../images/gallery/big-12.jpg" alt="" />
            <figcaption class="img-caption">
...
<script>
 ...
 <!-- gallery -->
               ...
               <script src="../js/gallery/jquery-1.8.2.min.js"></script>
