...
splashpageurl: "http://techfest.org/tempupload1/public/splash",
...
defineheader: '<div  font: bold 16px Verdana;background-color:black; background: black url(blockdefault.gif) center center repeat-x;"><a style="position:absolute; color:#fff;  top: 2px; right: 5px" href="javascript:splashpage.closeit()" title="Skip to Content">Skip</a></div>',
