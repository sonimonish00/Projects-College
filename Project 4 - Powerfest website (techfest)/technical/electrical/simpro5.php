...
<title>Circuit Tweaks | Powerfest - Techfest 2016</title>
...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<div class="white-area">
		...
		<img class="segment-img-small" src="../pics/poster/electrical/simpro.jpg" alt="img11"/>

		<div class="segment-content-desc">

	<h5>Circuit Tweaks</h5>
<div align="justify">	
		<p style="color:black;">In this event, PSIM/MATLAB simulations of various Transistor based circuits have to be done. Specific question regarding a minor tweaking of each circuit shall be asked and the participants shall predict the outcome of such a tweaking of the circuit, which they shall also confirm by simulation. The participants who are able to correctly predict and confirm the outcomes of such tweaking of circuits shall succeed.
		</p></div>
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
        ...
        <br><br>
        <td><a class="waves-effect waves-light btn-custom btn" href="../ele_simpro.php" target="_blank">REGISTER</a></td>
      </tr>
...
<ul class="collapsible" data-collapsible="accordion">
    <li>
      ...
      <p>
      	There shall be as many simulations as possible in the time limit of 2 hours. Every time an electronic circuit shall be given to simulate using PSIM/MATLAB (participants should be well versed in both these softwares). The result of the simulation should be correct as evaluated by the judges. Each participant shall, then be asked to predict the outcome of the circuit just simulated, if a minor change (tweaking) is done. Each participant shall then make the aforesaid change in their simulation model and obtain the outcome of the modified simulation. The participant whose simulation outcome is near to the predicted outcome shall get points. This shall be carried out for as many circuits, as possible in a span of two hours. At the end of the two hours, the top three participants shall be rewarded. In case of large number of students registering for this event, a screening test shall be conducted and suitable number of participants shall be shortlisted for the event.
      </p>    
...
<li>
      ...
      <div class="collapsible-body">
<p>  
PSIM/MATLAB simulations of various Transistor based circuits have to be done. Specific question regarding a minor tweaking of each circuit shall be asked and the participants shall predict the outcome of such a tweaking of the circuit, which they shall also confirm by simulation. The participants who are able to correctly predict and confirm the outcomes of such tweaking of circuits shall succeed.
</p> 
...
<li>2. Students from different educational institutions can form a team.</li>
     ...
     <li>
      ...
      <div class="collapsible-body">
        <p>Individual: One Participant per Team.</p>
        </div>
...
<table class="query-paragraph">
    ...
    <tr><td><pre><b>Student Co-Ordinator :</b><br>SHAH HARSH AJAYBHAI<br>7600987422</pre></td><td></td><td></td></tr>
