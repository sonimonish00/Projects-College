...
<title>Art of 3D | Powerfest - Techfest 2016</title>
...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<div class="white-area">
		...
		<img class="segment-img-small" src="../pics/poster/mechanical/artof3d2.jpg" alt="img11"/>

		<div class="segment-content-desc">

	<h5>Art of 3D</h5>
	
		<p align="justify" style="color:black;">The main aim of this event is to test the design ability of participant through evaluation of 3D space knowledge in a software assisted environment, any detailed/assembly image with dimensions of mechanical components/assembly are provided or any general design challenge given to the participants and they have to make a 3D part and Assembly for the same and animate them as per requirements given in the problem.
		</p>
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
        ...
        <br><br>
        <td><a class="waves-effect waves-light btn-custom btn" href="../mech_ao3.php" target="_blank">REGISTER</a></td>
      </tr>
...
<li>
      ...
      <p><ol>    
<li>1. Use of Personal LAPTOP is not allowed.</li>
<li>2. Participant can not use pendrive, CD/DVD or any other E- Material or Internet During compeptition hours.</li>
<li>3. Participants are not permitted to share solutions to problems.</li>
<li>4. Use of mobile phone is restricted during competition hours.</li>
<li>5. Use of solid work in the competetion is Compulsory no other modeling software permitted for competetion.</li>
<li>6. It is compulsory to create individual components of given problems and make assembly using assembly module of solidwork.</li>
<li>7. Participants are advised to save their work on their hard drives every ten (10) minutes.</li>
</ol></p>    
   ...
   <li>
      ...
      <div class="collapsible-body">
<p>
  Evaluation is based on time taken to complete the problem and use of advanced commands and use of number of command to create a 3D model here part created with minimum no of commands get maximum Score, also based on the task completed in asked problems.
</p> 
 ...
 <li>
      ...
      <div class="collapsible-body">
  <p>
  Any discipline of B.E./B.Tech Program.
  </p>
</div>
    </li>
...
<table class="query-paragraph">
    <tr>
    <td><pre><b>Faculty Co-Ordinator :</b><br>Prof. Hitesh R. Patel<br>9662243773</pre></td><td></td><td></td></tr>
    <tr><td><pre><b>Student Co-Ordinator :</b><br>Patel Harsh Naranbhai<br>8733928785</pre></td><td></td><td></td></tr>
