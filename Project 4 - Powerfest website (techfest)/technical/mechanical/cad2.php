...
<title>Autodestrus | Powerfest - Techfest 2016</title>
...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<div class="white-area">
		...
		<img class="segment-img-small" src="../pics/poster/mechanical/cad.jpg" alt="img11"/>

		<div class="segment-content-desc">

	<h5>Autodestrus</h5>
	
		<p align="justify" style="color:black;">The main aim of this event is to test the design ability of participant through evaluation of 2D space knowledge in a software assisted environment any detailed/assembly image with dimensions of mechanical components/assembly are provided to the participants and they have to make a drawing for the asked views with dimensions.
		</p>
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
        ...
        <br><br>
        <td><a class="waves-effect waves-light btn-custom btn" href="../mech_cad.php" target="_blank">REGISTER</a></td>
      </tr>
...
<li>5. Use of Auto CAD in 2D drawing competetion is Compulsory no other Drafting software permitted for competetion.</li>
<li>6. Participants are not permited for creating 3D part in 2D drawing competetion.</li>
<li>7. Participants are advised to save their work on their hard drives every ten (10) minutes.</li>
      ...
      <div class="collapsible-body">
<p>
  Evaluation is based on time taken to complete the problem and use of advanced command like line types, hatch, layers, dimension and productivity in the drawing.
</p> 
