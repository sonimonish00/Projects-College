...
<title>Robo Race | Powerfest - Techfest 2016</title>
...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<div class="white-area">
		...
		<img class="segment-img-small" src="../pics/general/race.jpg" alt="img11"/>

		<div class="segment-content-desc">

	<h5>Robo Race</h5>
	<div align="justify">
		<p style="color:black;">Robotics is a branch of engineering that involves the conception, design, manufacture, and operation of robots. This field overlaps with electronics, computer science, artificial intelligence, mechatronics, nanotechnology and bioengineering. A robotic competition is an event where robots have to accomplish a task. Usually they have to beat other robots in order to become the best one. Most competitions are for schools but several professional competitions are arising. Each year, an engineering challenge is presented in the form of a game. Students, with guidance from their teachers and mentors, use the Robotics Design System to build innovative robots designed to score the most points possible in qualification matches, elimination matches and Skills Challenges.
		</p>
		</div>
		</div>
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
        ...
        <br><br>
        <td><a class="waves-effect waves-light btn-custom btn" href="../gen_race.php" target="_blank">REGISTER</a></td>
      </tr>
...
<ul class="collapsible" data-collapsible="accordion">
    <li>
      ...
      <p><ol>    
<li>1. No. of participates per group: - Maximum 3 members.</li>
<li>2. Any team that is not ready at the event specified time will be disqualified.</li>
<li>3. The robot will be checked as per the specification by jury member appointed by the college before enters in to the tournament and if any failure may lead to disqualify.</li>
<li>4. Ready made robot, Please Excuse.</li>
<li>5. The size of robot must be within 35x 30 x 35 cm (Length x Width x Height).</li>
<li>6. The voltage specification for the robot should not exceed 24V.</li>
<li>7. Maximum 4 motors (each of 12V) are permitted for robot.</li>
<li>8. The weight of the Robot should not be more than 6 kg with battery.</li>
<li>9. No any kind of direct electric supply will be considered.</li>
</ol></p>    
...
<table class="query-paragraph">
    <tr>
    <td><pre><b>Faculty Co-Ordinator :</b><br>Prof. Girish S. Patel</pre></td><td></td><td></td></tr>
    <tr><td><pre><b>Student Co-Ordinator :</b><br>Meet Patel<br>9099559949</pre></td><td></td><td></td></tr>
