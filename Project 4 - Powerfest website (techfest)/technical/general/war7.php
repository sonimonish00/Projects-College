...
<title>Robo War | Powerfest - Techfest 2016</title>
...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
        ...
        <br><br>
        <td><a class="waves-effect waves-light btn-custom btn" href="../gen_war.php" target="_blank">REGISTER</a></td>
      </tr>
...
<ul class="collapsible" data-collapsible="accordion">
    <li>
      ...
      <p><ol>    
<li>1. The size of robot must be within 35 x 35 x 45 cm (Length x Width x Height) including weapon.</li>
<li>2. The voltage specification for the robot should not exceed 24V. Maximum 6 motors (each of 12V) are permitted for robot. The weight of the Robot should not be more than 6 kg with battery.</li>
<li>3. No any kind of direct electric supply will be considered.</li>
<li>4. The participating teams are allowed to use any sort of weapons.</li>      
...
<table class="query-paragraph">
    <tr>
    <td><pre><b>Faculty Co-Ordinator :</b><br>Prof. Rakesh A. Oza</pre></td><td></td><td></td></tr>
    <tr><td><pre><b>Student Co-Ordinator :</b><br>Vikas Patel<br>8460563471</pre></td><td></td><td></td></tr>
